...
<div class="hbd1">
    ...
    <div class="hbd1ri">
        ...
        <div class="hbd12 ssv">
        <ul><?php if(is_array($vod_news)): $i = 0; $__LIST__ = $vod_news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppvod): ++$i;$mod = ($i % 2 )?><li><span><?php echo (getcolordate('m-d',$ppvod["vod_addtime"])); ?></span><a href="<?php echo ($ppvod["list_url"]); ?>" target="_blank"><?php echo ($ppvod["list_name"]); ?></a> <a href="<?php echo ($ppvod["vod_url"]); ?>" title="<?php echo ($ppvod["vod_name"]); ?>"><?php echo (getcolor(msubstr($ppvod["vod_name"],0,14),$ppvod['vod_color'])); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?></ul>
        </div>
    </div>
</div>
<div class="hsa">
	<div class="hsalf">
		<dl class="tit"><dt><a href="<?php echo getlistname(1,'list_url');?>">电影大片</a></dt><dd><a href="<?php echo getlistname(1,'list_url');?>"><img src="<?php echo ($tpl); ?>images/more.gif" /></a></dd></dl>
        <!--电影大片左侧2张-->
        <div class="hbd1a ssv">
    ...
    <div class="hsari">
        <dl class="tit"><dt><a href="<?php echo getlistname(2,'list_url');?>">电视剧集</a></dt><dd><a href="<?php echo getlistname(2,'list_url');?>"><img src="<?php echo ($tpl); ?>images/more.gif" /></a></dd></dl>
        <div class="hbd1a ssv">
...
<div class="hsa">
	<div class="hsalf">
		<dl class="tit"><dt><a href="<?php echo getlistname(3,'list_url');?>">动漫卡通</a></dt><dd><a href="<?php echo getlistname(3,'list_url');?>"><img src="<?php echo ($tpl); ?>images/more.gif" /></a></dd></dl>
		<div class="hbd1a ssv">
...
<div class="hsae">
	<div class="hsae1">
        ...
        <div class="hbae11 ssv"><ul>
            <?php if(is_array($vod_hot_80)): $i = 0; $__LIST__ = $vod_hot_80;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppvod): ++$i;$mod = ($i % 2 )?><li><a href="<?php echo ($ppvod["vod_url"]); ?>" title="<?php echo ($ppvod["vod_name"]); ?>" target="_blank"><?php echo ($ppvod["list_name"]); ?> <?php echo (msubstr($ppvod["vod_name"],0,13)); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul></div>
	</div>
</div>
<div class="friend">
	<dl class="tit"><dt>友情链接</dt><dd>Powered by <strong><a href="http://www.haiyaotuan.com" target="_blank">舟舟影院!</a></strong> <em><?php echo C("admin_var");?></em></dd></dl>
